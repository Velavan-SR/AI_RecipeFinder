...
From similar recipes, here are ingredients used: ${allIngredients.join(', ')}
...
3. The flavor profile and texture

Return a JSON response:
{
  "substitute": "ingredient name",
  "reason": "1-2 sentence explanation why this works",
  "confidence": "high/medium/low"
    ...
    const response = await openai.chat.completions.create({
      model: 'gpt-4',
      messages: [
        { role: 'system', content: 'You are a culinary expert who understands ingredient substitutions and recipe compatibility.' },
